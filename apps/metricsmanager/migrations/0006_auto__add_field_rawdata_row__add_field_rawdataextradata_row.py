...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RawData.row'
        db.add_column(u'metrics_manager_rawdata', 'row',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=222),
                      keep_default=False)

        # Adding field 'RawDataExtraData.row'
        db.add_column(u'metrics_manager_rawdataextradata', 'row',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=222),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RawData.row'
        db.delete_column(u'metrics_manager_rawdata', 'row')

        # Deleting field 'RawDataExtraData.row'
        db.delete_column(u'metrics_manager_rawdataextradata', 'row')
    ...
    models = {
        ...
        u'metrics_manager.rawdata': {
            'Meta': {'ordering': "['id']", 'object_name': 'RawData'},
        ...
        u'metrics_manager.rawdataextradata': {
            'Meta': {'ordering': "['id']", 'object_name': 'RawDataExtraData'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
