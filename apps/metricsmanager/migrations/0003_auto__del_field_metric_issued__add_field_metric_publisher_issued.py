...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Metric.issued'
        db.delete_column('metricsmanager_metric', 'issued')

        # Adding field 'Metric.publisher_issued'
        db.add_column('metricsmanager_metric', 'publisher_issued',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Metric.issued'
        db.add_column('metricsmanager_metric', 'issued',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 14, 0, 0)),
                      keep_default=False)

        # Deleting field 'Metric.publisher_issued'
        db.delete_column('metricsmanager_metric', 'publisher_issued')
    ...
    models = {
        'metricsmanager.metric': {
            ...
            'publisher_issued': ('django.db.models.fields.DateField', [], {}),
