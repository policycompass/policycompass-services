...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Metric.issued'
        db.alter_column(u'metrics_manager_metric', 'issued', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Metric.issued'
        db.alter_column(u'metrics_manager_metric', 'issued', self.gf('django.db.models.fields.DateTimeField')())
