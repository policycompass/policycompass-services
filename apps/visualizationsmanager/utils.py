...
def get_rawdata_for_visualization(visualization, extras=True):
    from .models import Visualization
    if not type(visualization) is Visualization:
        raise ValueError('First argument is not a visualization model instance')
...
def save_rawdata_for_visualization(visualization, value):
