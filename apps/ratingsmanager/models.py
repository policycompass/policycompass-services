...
class Rating(models.Model):
    ...
    def calculate(self):
        ...
        """
        aggregates = self.rating_votes.aggregate(count=models.Count('score'), score=models.Avg('score'))
...
class RatingVote(models.Model):
    ...
    user_identifier = models.CharField(max_length=1024, validators=[RegexValidator("^(/[^/]*)+/?$")])
