...
class Base(APIView):
     ...
     def get(self, request, format=None):
        result = {
            ...
            "Create or Update Index for an itemtype ('metric','visualization','event','fuzzymap')": reverse('update_index_item', request=request,kwargs={'itemtype':'metric','itemid':26}),
            "Delete Index for an itemtype ('metric','visualization','event','fuzzymap')": reverse('delete_index_item', request=request,kwargs={'itemtype':'metric','itemid':26})
        }
